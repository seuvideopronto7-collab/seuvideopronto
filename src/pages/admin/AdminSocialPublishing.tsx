      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1.2fr_0.8fr] gap-6">
        ...
        <div className="cinema-panel p-6 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Button variant="neon" onClick={() => toast.success("Redes sociais prontas para conectar.") }>
              Conectar redes
            </Button>
            <Button variant="glass" onClick={() => toast.message("Publicacao iniciada.") }>
              Publicar agora
            </Button>
            <Button variant="glass" onClick={() => toast.success("Historico atualizado.") }>
              Registrar historico
            </Button>
          </div>
        </div>
